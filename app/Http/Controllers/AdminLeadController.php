...
class AdminLeadController extends Controller
{
    ...
    public function index()
    {
        $userId = Auth::user()->id;
         ...
         $currentMonth = date('m');
      /* $leadsdata =  leads::where('tobranchs',$userBranch)->get();*/
       ...
       $sourcedata = Source::get();
        ...
        {
            $da = leadsfollowups::where('leadsfrom','=',$leas->id)->where('fstatus',0)->first();
        ...
        return view('admin.leads.manage',compact('leadsdata','folss','dates','userdata','cour','sourcedata','branchdata','ccatall'));
    }
    ...
    public function create()
    {
        ...
        $fol = followup::get();
        return view('admin.leads.create',compact('sourcedata','userdata','branchdata','coursedata','fol'));
    }
    ...
    public function store(Request $request)
    {
       ...
       if(is_array($data)) 
        ...
        return redirect('/admin-users-leads')->with('success','Leads Created Successfully!!');
    }
...
/*
      ...
      foreach($leadsdata as $leas)
        ...
        return view('admin.leads.marketingusersleads',compact('leadsdata','folss','dates','userdata','cour','sourcedata','branchdata','ccatall'));
    ...
    public function edit($id)
    {
        ...
        $fol = followup::get();
        return view('admin.leads.edit',compact('sourcedata','userdata','branchdata','coursedata','leadsda','selectedcourse','fol'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       if(is_array($data)) 
        ...
        return redirect('/admin-users-leads')->with('success','Leads Updated Successfully!!');
    }
    ...
    {
        return \Excel::download(new LeadExport, 'leadsdatass.xls');
    ...
    {   
        ...
        if($namedatas = $request->getstudentsnames)
        {
            ...
            foreach($namesfinds as $leas)
             ...
             return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
        }
        ...
        elseif($mobdatas = $request->getMobilesno)
        {
            ...
            foreach($namesfinds as $leas)
             ...
             return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','mobdatas','namedatas','datesfor','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
        }
                ...
                $userdata = User::get();
                   $cour = course::all();
                    ...
                    foreach($namesfinds as $leas)
                     ...
                     return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','startdates','enddats','mobdatas','namedatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
                }
        ...
        elseif($coursedatas = $request->coursedatas)
        {
            ...
            foreach($namesfinds as $leas)
             ...
             return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','coursedatas','cstarstdates','cendatea','namedatas','mobdatas','coursedatas','datesfor','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
        }
        ...
        elseif($cmodes = $request->CourseModeSearch)
        {
            ...
            foreach($namesfinds as $leas)
             ...
             return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','cmodes','mobdatas','datesfor','coursedatas','namedatas','sources','fsearch','asearch','bransdata','categorydata'));
        }
        ...
        elseif($sources = $request->sourceSearch)
        {
            ...
            foreach($namesfinds as $leas)
             ...
             return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','sources','datesfor','namedatas','mobdatas','coursedatas','cmodes','starsdates','enssdates','fsearch','asearch','bransdata','categorydata'));
        }
        ...
        elseif($fsearch = $request->FollowupsSearch)
        {
            ...
            $namesfinds = leads::select("users.name","leads.*","leadsfollowups.followupstatus","leadsfollowups.takenby","leadsfollowups.flfollwpdate","leadsfollowups.flremarsk","leadsfollowups.nxtfollowupdate")->join("users","users.id","=","leads.user_id")->join("leadsfollowups","leadsfollowups.leadsfrom","=","leads.id")->where('leadsfollowups.followupstatus',$fsearch)->whereBetween('leads.leaddate',[$fdates,$fenddates])->orderBy('leads.leaddate','DESC')->groupBy('leadsfollowups.leadsfrom')->get();
                    ...
                    foreach($namesfinds as $leas)
                     ...
                     return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','fdates','fenddates','asearch','bransdata','categorydata'));
        }
        ...
        elseif($asearch = $request->AssignedToSearch)
        {
            ...
            $namesfinds = leads::select("leads.*","users.name")->join("users","users.id","=","leads.user_id")->where('leads.user_id',$asearch)->whereBetween('leads.leaddate',[$asdates,$aenddates])->orderBy('leads.leaddate','DESC')->get();
                    ...
                    foreach($namesfinds as $leas)
                     ...
                     return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','asdates','aenddates','bransdata','categorydata'));
        }
        ...
        elseif($bransdata = $request->branchSearchDatas)
        {
            ...
            $namesfinds =  leads::select("leads.*","users.name")->join("users","users.id","=","leads.user_id")->where('leads.branch',$bransdata)->whereBetween('leads.leaddate',[$bstartdate,$benddate])->orderBy('leads.leaddate','DESC')->get();
                    ...
                    foreach($namesfinds as $leas)
                     ...
                     return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','bstartdate','benddate','categorydata'));
        }
        ...
        elseif($categorydata = $request->categorysDatas)
        {
            ...
            $namesfinds = leads::select("leads.*","users.name")->join("users","users.id","=","leads.user_id")->whereIn('leads.course',$findcourse)->whereBetween('leads.leaddate',[$cstartdate,$cenddate])->orderBy('leads.leaddate','DESC')->get();
                    ...
                    foreach($namesfinds as $leas)
                     ...
                     return view('admin.leads.filtersleads',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartdate','cenddate'));
        }
