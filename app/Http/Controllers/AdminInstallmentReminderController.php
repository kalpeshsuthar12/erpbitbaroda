...
class AdminInstallmentReminderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.installmentreminder.manage',compact('getdatas','regetdatas','folss','cour','branchdata','userdata','sourcedata','ccatall'));
    }
     ...
     public function upcominginstallments()
    {
        ...
        return view('admin.installmentreminder.upcominginastallments',compact('getdatas','regetdatas','folss','cour','branchdata','userdata','sourcedata','ccatall'));
    }
    ...
    public function currentsinstallments()
    {
        ...
        return view('admin.installmentreminder.currentinstallment',compact('getdatas','regetdatas','folss','cour','branchdata','userdata','sourcedata','ccatall'));
    }
    ...
    public function droplists()
    {
       $getdatas = admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
        ...
        return view('admin.installmentreminder.dropplist',compact('getdatas','folss'));
    }
    ...
    public function filterinsatllmentreminder(Request $request)
    {
        ...
        if($namedatas = $request->getstudentsnames)
      {
       ...
       //  $namesfinds = leads::select("leads.*","users.name")->join("users","users.id","=","leads.user_id")->Where('studentname', 'like', '%' .$namedatas. '%')->get();
         ...
         // $namesfinds = admissionprocess::select('admissionprocesses.*','payments.*','admissionprocesses.id as aid')->join('payments', 'payments.inviceid', '=', 'admissionprocesses.id')->Where('admissionprocesses.studentname', 'like', '%' .$namedatas. '%')->orderBy('payments.paymentdate','DESC')->get(); 
          ...
          return view('admin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
      }
         ...
         if($datesfor == "Installment Date")
         {
            ...
            $userdata = User::get();
             ...
             ->get();
                ...
                return view('admin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','startdates','enddats'));
            }
      ...
      elseif($coursedatas = $request->coursedatas)
      {
         ...
         $namesfinds =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
          ...
          return view('admin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartsdates','cendsdates'));
      }
     ...
     /* elseif($cmodes = $request->CourseModeSearch)
      ...
      elseif($sources = $request->sourceSearch)
      {
         ...
         // $namesfinds = admissionprocess::select('admissionprocesses.*','payments.*','admissionprocesses.id as aid')->join('admissionprocesscourses','admissionprocesscourses.invid','=','admissionprocesses.id')->join('payments', 'payments.inviceid', '=', 'admissionprocesses.id')->where('admissionprocesses.admsisource',$sources)->whereBetween('payments.paymentdate',[$starsdates,$enssdates])->orderBy('payments.paymentdate','DESC')->get(); 
          ...
          return view('admin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','starsdates','enssdates'));
      }
          ...
          //$namesfinds = admissionprocess::select('admissionprocesses.*','payments.*','admissionprocesses.id as aid')->join('admissionprocesscourses','admissionprocesscourses.invid','=','admissionprocesses.id')->join('payments', 'payments.inviceid', '=', 'admissionprocesses.id')->where('admissionprocesses.admissionsusersid',$asearch)->whereBetween('payments.paymentdate',[$asdates,$aenddates])->groupBy('payments.inviceid')->orderBy('payments.paymentdate','DESC')->get(); 
            ...
            ->where('admissionprocesses.admissionsusersid',$asearch)->whereBetween('payments.paymentdate',[$asdates,$aenddates])
             ...
             ->get();
                ...
                return view('admin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','asdates','aenddates'));
      }
          ...
          $namesfinds =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
            ...
            ->where('admissionprocesses.stobranches',$bransdata)->whereBetween('payments.paymentdate',[$bstartdate,$benddate])
             ...
             ->get();
                ...
                return view('admin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','bstartdate','benddate'));
      }
         ...
         $namesfinds =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
            ...
            ->where('admissionprocesscourses.courseid',$findcourse)->orWhere('admissionprocesscourses.univecoursid',$findcourse)->whereBetween('payments.paymentdate',[$cstartdate,$cenddate])
             ...
             ->get();
                ...
                return view('admin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartdate','cenddate'));
      } 
    ...
    public function completedinstallment(Request $request)
    {
       ...
       $getdatas =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
        ...
        return view('admin.installmentreminder.completedinstallment',compact('getdatas')); 
    }
           ...
           // dd($getadmissionsdetails);
            ...
            foreach($getadmissionsdetails as $key => $dtasysl)
            {
             ...
             $getreminderdata = payment::where('inviceid',$dtasysl->id)->orderBy('id','DESC')->first();
                ...
                Mail::send('admin.installmentreminder.installmentreminder', $data, function ($message) use ($data) {
                    $data;
    ...
    public function edit()
    {
       ...
       $getdatas =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
        ...
        return view('admin.installmentreminder.installmentlist',compact('getdatas','regetdatas','folss','userdata','branchdata','ccatall','cour','sourcedata'));
    }
        ...
        if($namedatas = $request->getstudentsnames)
      {
       ...
       //  $namesfinds = leads::select("leads.*","users.name")->join("users","users.id","=","leads.user_id")->Where('studentname', 'like', '%' .$namedatas. '%')->get();
         ...
         ->get();
          ...
          return view('admin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
      }
      ...
      {  
        ...
        ->orderBy('payments.nexamountdate','DESC')
         ...
         ->get();
                ...
                return view('admin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','startdates','enddats'));
            }
      ...
      elseif($coursedatas = $request->coursedatas)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
          ...
          return view('admin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartsdates','cendsdates'));
      }
      ...
      elseif($sources = $request->sourceSearch)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
          ...
          return view('admin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','starsdates','enssdates'));
      }
      ...
      elseif($asearch = $request->AssignedToSearch)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
                ...
                return view('admin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','asdates','aenddates'));
      }
      ...
      elseif($bransdata = $request->branchSearchDatas)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
                ...
                return view('admin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','bstartdate','benddate'));
      }
      ...
      elseif($categorydata = $request->categorysDatas)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
                ...
                return view('admin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartdate','cenddate'));
      } 
