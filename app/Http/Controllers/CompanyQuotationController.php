...
class CompanyQuotationController extends Controller
{
    ...
    public function index()
    {
        ...
        $quodetails = studentsQuotation::join('students_quotation_courses','students_quotation_courses.stucompyid','=','students_quotations.id')->select('students_quotations.*','students_quotation_courses.*','students_quotations.id as admid')->groupBy('students_quotation_courses.stucompyid')->orderBy('students_quotations.quotationsdates','desc')->get();
      ...
      public function viewquotations($id)
    {
        ...
        return view('superadmin.quotation.quoteview',compact('getdetails','coursedetailsv'));
    }
        ...
        else if($branhanch == "MANIPAL") 
        {
         ...
         $invsjqno ="0";
            ...
            'invmanipalnos'=> $invmanipalqno,
             ...
             return redirect('/show-invoices-details/'.$id)->with('success','Invoices Created SuccessFully!!!');  


      
    }

    public function branchquotation($banch)
    {
         if($banch == "BITSJ")
        {
            ...
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('sjqnos');
            //dd($latests);
            $mj = isset($latests[0]) ? $latests[0] : false;
            $counts = $mj + 1;
            $code_nos = str_pad($counts, 4, "0", STR_PAD_LEFT);
            $value = 'BITSJ-Quo/'.$code_nos;
        ...
        else if($banch == "BITMJ") 
        {
            ...
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('mjqnos');
            //$latests = admissionprocess::get()->pluck('mjerno')->toArray();
            $mj = isset($latests[0]) ? $latests[0] : false;
            $counts = $mj + 1;
            $code_nos = str_pad($counts, 4, "0", STR_PAD_LEFT);
            $value = 'BITMJ-Quo/'.$code_nos;
            return response()->json($value);
        }
          ...
          else if($banch == "BITWG") 
        {
            ...
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('wgqnos');
            $mj = isset($latests[0]) ? $latests[0] : false;
            $counts = $mj + 1;
            $code_nos = str_pad($counts, 4, "0", STR_PAD_LEFT);
            $value = 'BITWG-Quo/'.$code_nos;
            return response()->json($value);
        }
         ...
         else if($banch == "BITOL") 
        {
            ...
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('bitolqnos');
            /*$lates = admissionprocess::get()->pluck('wgerno')->toArray();*/
            //dd($lates);
            $wg = isset($lates[0]) ? $lates[0] : false;
            $counted = $wg + 1;
            $kode = str_pad($counted, 4, "0", STR_PAD_LEFT);
            $value = 'BITOL-Quo/'.$kode;
            return response()->json($value);
        }
        ...
        else if($banch == "BITEL") 
        {
            ...
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('elqnos');
            /*$lates = admissionprocess::get()->pluck('wgerno')->toArray();*/
            //dd($lates);
            $wg = isset($lates[0]) ? $lates[0] : false;
            $counted = $wg + 1;
            $kode = str_pad($counted, 4, "0", STR_PAD_LEFT);
            $value = 'BITEL-Quo/'.$kode;
            return response()->json($value);
        }
         else if($banch == "CVRU(BL)") 
        {
           
            $latests = studentsQuotation::where('stobranches','=',$banch)->latest()->get()->pluck('cvrublqnos');
            /*$lates = admissionprocess::get()->pluck('wgerno')->toArray();*/
            //dd($lates);
            $wg = isset($lates[0]) ? $lates[0] : false;
            $counted = $wg + 1;
            $kode = str_pad($counted, 4, "0", STR_PAD_LEFT);
            $value = 'CVRU(BL)-Quo/'.$kode;
            return response()->json($value);
        }
         else if($banch == "CVRU (KH)") 
        {
           
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('cvrukhqnos');
            $wg = isset($lates[0]) ? $lates[0] : false;
            $counted = $wg + 1;
            $kode = str_pad($counted, 4, "0", STR_PAD_LEFT);
            $value = 'CVRU(KH)-Quo/'.$kode;
            return response()->json($value);
        }
         else if($banch == "RNTU") 
        {
           
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('rntuqnos');
            $wg = isset($lates[0]) ? $lates[0] : false;
            $counted = $wg + 1;
            $kode = str_pad($counted, 4, "0", STR_PAD_LEFT);
            $value = 'RNTU-Quo/'.$kode;
        ...
        else if($banch == "MANIPAL") 
        {
           
            $latests = studentsQuotation::where('scbranch','=',$banch)->latest()->get()->pluck('manipalnos');
            $wg = isset($lates[0]) ? $lates[0] : false;
            $counted = $wg + 1;
            $kode = str_pad($counted, 4, "0", STR_PAD_LEFT);
            $value = 'MANIPAL-Quo/'.$kode;
            return response()->json($value);
        }
    }


    public function brancheswiseINvo($branhanch)
    {
         if($branhanch == "BITSJ")
        {
    ...
    public function create(Request $request)
    {
       ...
       // dd($getid);
        ...
        return view('superadmin.quotation.create',compact('quotationdetails','cours','value','brnachdata'));
    ...
    public function editquotations($id,Request $request)
    {
        ...
        $brnachdata = Branch::get();
            ...
            return view('superadmin.quotation.edit',compact('quotationdetails','cours','brnachdata','sccourses'));
    }
    ...
    public function updateQuotations($id,Request $request)
    {
           ...
           $quotationdetails->studentscategorys = $qcategorys;
            ...
            $studcompid = $id;
                ...
                $getCourseDetasils = studentsQuotationCourses::select('courses.coursename','students_quotation_courses.*')->Join('courses','courses.id','=','students_quotation_courses.studecompcourse')->where('students_quotation_courses.stucompyid',$id)->get();
                     ...
                     $pdf = PDF::loadView('superadmin.quotation.viewquotations',compact('getUserQuotationDetails','getCourseDetasils'))->setOptions(['defaultFont' => 'sans-serif']);
                        ...
                        $message->to($data["email"], $data["email"])
                           ...
                           ->cc('support@bitbaroda.com','Admission BIT')
                            ...
                            if (Mail::failures()) {
                                        ...
                                        return redirect('/quotation')->with('success','Quotation Update SuccessFully and Email Sent Successfully!!!');
                ...
                //return view('superadmin.quotation.viewquotations',compact('getUserQuotationDetails','getCourseDetasils'));exit;
        //         $view = view('superadmin.quotation.viewquotations', ['getUserQuotationDetails'=> $getUserQuotationDetails,'getCourseDetasils'=>$getCourseDetasils]);
        //         $html = $view->render();
        //         $pdf = PDF::loadHTML($html)->setPaper('a4');            
        // return $pdf->download('sugeneruoti.pdf');
        //           exit;
                $pdf = PDF::loadView('superadmin.quotation.viewquotations',['getUserQuotationDetails'=> $getUserQuotationDetails,'getCourseDetasils'=>$getCourseDetasils])->setOptions(['defaultFont' => 'sans-serif']);
                   /* return $pdf->stream();
                        exit;*/
                     $data = array('CompanyName' => $Comapanyname, 'ContactPerson' => $contactperson, 'QuoteDate' => $inquirydate); 
                     $data["email"] = $getUserQuotationDetails->scemail;
        ...
        //return redirect('/quotation')->with('success','Quotations Updated Successfully!!');
    }
    ...
    public function view(Request $request)
    {
        $getids = $request->quotationid;
         ...
         $getmobiles = leads::where('id',$getids)->pluck('phone');
          ...
          $result = CompanyQuotation::where('cphoneno',$getmobiles)->orderBy('quotatdate')->get();
            ...
            foreach($result as $res)
        {
            ...
            $row[] = '<a href="/view-quotations-details/'.$res->id.'"  class="btn btn-primary">View</a>';
            $row[] = $res->quotationno;
    ...
    public function store(Request $request)
    {
            ...
            'qleaddates'=> $request->leaddates,
            'leadids'=> $request->leadid,
            'subranchse'=> $request->frombranch,
                        ...
                        $message->to($data["email"], $data["email"])
                           ...
                           ->cc('support@bitbaroda.com','Admission BIT')
                            ...
                            if (Mail::failures()) {
                                        ...
                                        return redirect('/quotation')->with('success','Quotation Create SuccessFully and Email Sent Successfully!!!');
    ...
    public function shwoinvociesdetails($id)
    {
       ...
       // $invocicescoursedetails = QuotationInvoicesCourses::Join('courses','courses.id','=','quotation_invoices_courses.invstudecompcourse')->select('quotation_invoices_courses.*','courses.coursename')->where('quotation_invoices_courses.invstucompyid',$id)->get();
        
        $aprocess = studentsQuotation::join('quotation_invoices','quotation_invoices.quotationsid','=','students_quotations.id')->select('students_quotations.*','quotation_invoices.*','students_quotations.id as sid')->where('students_quotations.id',$id)->first();
        ...
        return view('superadmin.quotation.invoicesview',compact('aprocess','invocicescoursedetails','id'));
    ...
    public function invoiceslist($id)
    {
        ...
        return view('superadmin.quotation.invoiceslists',compact('invlists','invoicessname'));
    }
    ...
    public function convertoadmissionproccess($id)
    {
       ...
       // dd($directstudentsdata);
        ...
        return view('superadmin.quotation.convertoadmissionproccess',compact('cours','branchdetails','cours','course','taxesna','ucats','directstudentsdata'));
    }   
    ...
    public function edit(CompanyQuotation $companyQuotation,Request $request)
    {
       ...
       /*dd($request->all());*/
        ...
        $acategory  = $request->admissionscategory;
...

        {
           ...
           return redirect('/create-company-payment/'.$invoicesid);
                             ...
                             for($m=0; $m < (count($cstudentsnames)); $m++)
                        {
                                               ...
                                               $branhanch = $request->tobranchessw;
                                                         ...
                                                         if($branhanch == "BITSJ")
                                                        {
                                                            ...
                                                            $latests_csjerno = Companys_Admissions::select('csjerno')->where('cbranchs','=',$branhanch)->latest()->first();
                                                            $csjerno_no = 1;
                                                           // $counts = 1;
                                                            if(isset($latests_csjerno)){
                                                                $csjerno_no = $latests_csjerno->csjerno + 1;
                                                            }
                                                            $code_nos = str_pad($csjerno_no, 4, "0", STR_PAD_LEFT);
                                                            $value = 'BITSJ-COMP/'.$code_nos;
    ...
    public function update($id,Request $request, CompanyQuotation $companyQuotation)
    {
        ...
        return view('superadmin.quotation.createpayment',compact('paymentdetails','branc','psource'));
    }
    ...
    public function destroy($id,CompanyQuotation $companyQuotation,Request $request)
     {
       ...
       if($leadupodat)
       {
        ...
        return redirect('/company-paymentreceipt/'.$paymentid)->with('success','Payment Successfully Done!!!');
    }
    ...
    public function companypaymentreceipts($id)
    {
      ...
      //   dd($payments);
        ...
        return view('superadmin.quotation.paymentreceipt',compact('aprocess','invvcoursed','univCourse','paymentdata','makepayment','installdata','selectID','compadmissiondetails'));
