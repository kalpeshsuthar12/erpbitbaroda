...
class AdminQuotationController extends Controller
{
    ...
    {   
        ...
        return view('admin.quotation.manage',compact('quodetails'));
    ...
    public function create(Request $request)
    {
       ...
       // dd($getid);
        ...
        return view('admin.quotation.create',compact('quotationdetails','cours','value','brnachdata'));
     ...
     public function editquotations($id,Request $request)
    {
        ...
        $brnachdata = Branch::get();
            ...
            return view('admin.quotation.edit',compact('quotationdetails','cours','brnachdata','sccourses'));
    }
    ...
    public function updateQuotations($id,Request $request)
    {
                        ...
                        $message->to($data["email"], $data["email"])
                           ...
                           ->cc('support@bitbaroda.com','Admission BIT')
                            ...
                            if (Mail::failures()) {
                                        ...
                                        return redirect('/admins-quotation')->with('success','Quotation Update SuccessFully and Email Sent Successfully!!!');
        ...
        //return redirect('/admins-quotation')->with('success','Quotations Updated Successfully!!');
    }
    ...
    public function store(Request $request)
   {
                        ...
                        $message->to($data["email"], $data["email"])
                           ...
                           ->cc('support@bitbaroda.com','Admission BIT')
                            ...
                            if (Mail::failures()) {
                                        ...
                                        return redirect('/admins-quotation')->with('success','Quotation Create SuccessFully and Email Sent Successfully!!!');
       ...
       public function viewquotations($id)
    {
        ...
        return view('admin.quotation.quoteview',compact('getdetails','coursedetailsv'));
        ...
        else if($branhanch == "MANIPAL") 
        {
         ...
         $invsjqno ="0";
            ...
            'invmanipalnos'=> $invmanipalqno,
             ...
             return redirect('/admins-show-invoices-details/'.$id)->with('success','Invoices Created SuccessFully!!!');  
     ...
     public function invoiceslist($id)
    {
        ...
        return view('admin.quotation.invoiceslists',compact('invlists','invoicessname'));
    }
    ...
    public function shwoinvociesdetails($id)
    {
       ...
       // $invocicescoursedetails = QuotationInvoicesCourses::Join('courses','courses.id','=','quotation_invoices_courses.invstudecompcourse')->select('quotation_invoices_courses.*','courses.coursename')->where('quotation_invoices_courses.invstucompyid',$id)->get(); 'subranchse'=> $userBranchs,
        ...
        return view('admin.quotation.invoicesview',compact('aprocess','invocicescoursedetails','id'));
    ...
    public function convertoadmissionproccess($id)
    {
       ...
       // dd($directstudentsdata);
        ...
        return view('admin.quotation.convertoadmissionproccess',compact('cours','branchdetails','cours','course','taxesna','ucats','directstudentsdata'));
    }  
    ...
    public function show(Request $request)
    {
        ...
        return view('admin.quotation.filterquotations',compact('leadsMob'));
    }
        ...
        if($acategory == "Students") 
         {
            ...
            $invoicesid = $admissionprocess->id;
              ...
              return redirect('/admins-create-company-payment/'.$invoicesid);
  ...
  public function update($id,Request $request, CompanyQuotation $companyQuotation)
    {
        ...
        return view('admin.quotation.createpayment',compact('paymentdetails','branc','psource'));
    }
    ...
    public function destroy($id,CompanyQuotation $companyQuotation,Request $request)
     {
       ...
       if($leadupodat)
       {
        ...
        return redirect('/admins-company-paymentreceipt/'.$paymentid)->with('success','Payment Successfully Done!!!');
    }
    ...
    public function companypaymentreceipts($id)
    {
      ...
      //   dd($payments);
        ...
        return view('admin.quotation.paymentreceipt',compact('aprocess','invvcoursed','univCourse','paymentdata','makepayment','installdata','selectID','compadmissiondetails'));
