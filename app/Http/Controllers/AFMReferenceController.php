...
class AFMReferenceController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('affiliatesmarketing.references.manage',compact('refersdata'));
    }
    ...
    public function create()
    {
        $usersdata = User::all();
         ...
         return view('affiliatesmarketing.references.create',compact('usersdata','coursedata'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $logsData = $logsDatamodel->create([
            ...
            return redirect('/affiliates-marketing-references')->with('success','References Created Successfully');
        } 
        else {
           
             return redirect('/affiliates-marketing-references')->with('success','Oops something went wrong, References not saved');
        }
    ...
    public function edit($id)
    {
        ...
        $usersdata = User::all();
         ...
         return view('affiliatesmarketing.references.edit',compact('refe','usersdata','coursedata'));
    }
