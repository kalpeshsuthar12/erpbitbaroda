...
class InstallmentReminderController extends Controller
{
    ...
    public function index()
    {
              ...
              $all_data = [];
                foreach($getdatas_ss as $key=> $installdatas){
                                                 ...
                                                 $currentMonth = date('m');
                                                  ...
                                                  $paymentsreceived = DB::table('payments')->where('inviceid',$installdatas->admid)->sum('paymentreceived');
                                                    ...
                                                    $cvrucoursedetails = DB::table('admissionprocesscourses')->join('courses','courses.id','=','admissionprocesscourses.univecoursid')->selectRaw('GROUP_CONCAT(coursename) as course_name')->where('admissionprocesscourses.invid',$installdatas->admid)->groupBy('admissionprocesscourses.invid')->first();
                                                            ...
                                                            $admissionsof = DB::table('users')->join('admissionprocesses','admissionprocesses.admissionsusersid','=','users.id')->select('users.name')->where('admissionprocesses.id',$installdatas->admid)->first();
                                            ...
                                            if($installdatas->invtotal != $getallpaymentsreceived && $installdatas->droppedstats != '1'){
                                                ...
                                                $all_data[$key]['AdmissionsBranhcs'] = $installdatas->stobranches;
                                                ...
                                                $all_data[$key]['users_names'] = $admissionsof->name;
                                            }
              ...
              $rall_data = [];
                foreach($regetdatas_ss as $key=> $installdatas){
                                                 ...
                                                 $currentMonth = date('m');
                                                  ...
                                                  $paymentsreceived = DB::table('payments')->where('reinviceid',$installdatas->reid)->sum('paymentreceived');
                                                    ...
                                                    $cvrucoursedetails = DB::table('readmissioncourses')->join('courses','courses.id','=','readmissioncourses.reunivecoursid')->selectRaw('GROUP_CONCAT(coursename) as course_name')->where('readmissioncourses.reinvid',$installdatas->reid)->groupBy('readmissioncourses.reinvid')->first();
                                                            ...
                                                            $readmissionsof = DB::table('users')->join('re_admissions','re_admissions.ruserid','=','users.id')->select('users.name')->where('re_admissions.id',$installdatas->reid)->first();
                                            ...
                                            if($installdatas->rinvtotal != $getallpaymentsreceived && $installdatas->droppedstats != '1'){
                                                ...
                                                $rall_data[$key]['rstudents'] = $installdatas->rstudents;
                                                $rall_data[$key]['rusers_names'] = $readmissionsof->name;
                                                $rall_data[$key]['rstobranches'] = $installdatas->rstobranches;
                                                if($cvrucoursedetails){
        ...
        return view('superadmin.installmentreminder.manage',compact('getdatas','regetdatas','folss','cour','branchdata','userdata','sourcedata','ccatall'));
    }
     ...
     public function upcominginstallments()
    {
        ...
        return view('superadmin.installmentreminder.upcominginastallments',compact('getdatas','regetdatas','folss','cour','branchdata','userdata','sourcedata','ccatall'));
    }
    ...
    public function currentsinstallments()
    {
        ...
        return view('superadmin.installmentreminder.currentinstallment',compact('getdatas','regetdatas','folss','cour','branchdata','userdata','sourcedata','ccatall'));
    }
    ...
    public function droplists()
    {
       $getdatas = admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
        ...
        return view('superadmin.installmentreminder.dropplist',compact('getdatas','folss'));
    }
    ...
    public function filterinsatllmentreminder(Request $request)
    {
        ...
        if($namedatas = $request->getstudentsnames)
      {
       ...
       //  $namesfinds = leads::select("leads.*","users.name")->join("users","users.id","=","leads.user_id")->Where('studentname', 'like', '%' .$namedatas. '%')->get();
         ...
         // $namesfinds = admissionprocess::select('admissionprocesses.*','payments.*','admissionprocesses.id as aid')->join('payments', 'payments.inviceid', '=', 'admissionprocesses.id')->Where('admissionprocesses.studentname', 'like', '%' .$namedatas. '%')->orderBy('payments.paymentdate','DESC')->get(); 
          ...
          return view('superadmin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
      }
         ...
         if($datesfor == "Installment Date")
         {
            ...
            $userdata = User::get();
             ...
             ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','startdates','enddats'));
            }
      ...
      elseif($coursedatas = $request->coursedatas)
      {
         ...
         $namesfinds =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
          ...
          return view('superadmin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartsdates','cendsdates'));
      }
     ...
     /* elseif($cmodes = $request->CourseModeSearch)
      ...
      elseif($sources = $request->sourceSearch)
      {
         ...
         // $namesfinds = admissionprocess::select('admissionprocesses.*','payments.*','admissionprocesses.id as aid')->join('admissionprocesscourses','admissionprocesscourses.invid','=','admissionprocesses.id')->join('payments', 'payments.inviceid', '=', 'admissionprocesses.id')->where('admissionprocesses.admsisource',$sources)->whereBetween('payments.paymentdate',[$starsdates,$enssdates])->orderBy('payments.paymentdate','DESC')->get(); 
          ...
          return view('superadmin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','starsdates','enssdates'));
      }
          ...
          //$namesfinds = admissionprocess::select('admissionprocesses.*','payments.*','admissionprocesses.id as aid')->join('admissionprocesscourses','admissionprocesscourses.invid','=','admissionprocesses.id')->join('payments', 'payments.inviceid', '=', 'admissionprocesses.id')->where('admissionprocesses.admissionsusersid',$asearch)->whereBetween('payments.paymentdate',[$asdates,$aenddates])->groupBy('payments.inviceid')->orderBy('payments.paymentdate','DESC')->get(); 
            ...
            ->where('admissionprocesses.admissionsusersid',$asearch)->whereBetween('payments.paymentdate',[$asdates,$aenddates])
             ...
             ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','asdates','aenddates'));
      }
          ...
          $namesfinds =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
            ...
            ->where('admissionprocesses.stobranches',$bransdata)->whereBetween('payments.paymentdate',[$bstartdate,$benddate])
             ...
             ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','bstartdate','benddate'));
      }
         ...
         $namesfinds =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
            ...
            ->where('admissionprocesscourses.courseid',$findcourse)->orWhere('admissionprocesscourses.univecoursid',$findcourse)->whereBetween('payments.paymentdate',[$cstartdate,$cenddate])
             ...
             ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallment',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartdate','cenddate'));
      } 
    ...
    public function completedinstallment(Request $request)
    {
       ...
       $getdatas =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
        ...
        return view('superadmin.installmentreminder.completedinstallment',compact('getdatas')); 
    }
           ...
           // dd($getadmissionsdetails);
            ...
            foreach($getadmissionsdetails as $key => $dtasysl)
            {
             ...
             $getreminderdata = payment::where('inviceid',$dtasysl->id)->orderBy('id','DESC')->first();
                ...
                Mail::send('superadmin.installmentreminder.installmentreminder', $data, function ($message) use ($data) {
                    $data;
    ...
    public function edit()
    {
       ...
       $getdatas =  admissionprocess::select('admissionprocesses.*', 'payments.*','admissionprocesses.id as admid')
             ...
             foreach($getdatas as $leas)
                {
                    $da = payment::where('inviceid','=',$leas->admid)->orderBy('id','DESC')->first();

                    $leas->paymentreceived ='';
                    $leas->remainingamount ='';
                    $leas->nexamountdate ='';
                        $leas->paymentdate = '';
                        
                    if($da){
                        $leas->paymentreceived = $da->paymentreceived;
                        $leas->remainingamount = $da->remainingamount;
                        $leas->nexamountdate = $da->nexamountdate;
                        $leas->paymentdate = $da->paymentdate;
                        //$foldate = date('d-m-Y',strtotime($leas->flfollwpdate));
                        //dd($leas->nexamountdate = $da->nexamountdate);
                                //dd($foldate);
                    }
                }

        $regetdatas = payment::select('re_admissions.*','payments.*','payments.id as pids','re_admissions.id as reid')->join('re_admissions','re_admissions.id','=','payments.reinviceid') ->where('payments.nexamountdate','!=',NULL)->groupBy('payments.reinviceid')->latest('payments.nexamountdate')->get();
        ...
        return view('superadmin.installmentreminder.installmentlist',compact('getdatas','regetdatas','folss','userdata','branchdata','ccatall','cour','sourcedata'));
    }
        ...
        if($namedatas = $request->getstudentsnames)
      {
       ...
       //  $namesfinds = leads::select("leads.*","users.name")->join("users","users.id","=","leads.user_id")->Where('studentname', 'like', '%' .$namedatas. '%')->get();
         ...
         ->get();
          ...
          return view('superadmin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata'));
      }
      ...
      {  
        ...
        ->orderBy('payments.nexamountdate','DESC')
         ...
         ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','startdates','enddats'));
            }
      ...
      elseif($coursedatas = $request->coursedatas)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
          ...
          return view('superadmin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartsdates','cendsdates'));
      }
      ...
      elseif($sources = $request->sourceSearch)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
          ...
          return view('superadmin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','starsdates','enssdates'));
      }
      ...
      elseif($asearch = $request->AssignedToSearch)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','asdates','aenddates'));
      }
      ...
      elseif($bransdata = $request->branchSearchDatas)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','bstartdate','benddate'));
      }
      ...
      elseif($categorydata = $request->categorysDatas)
      {
        ...
        ->orderBy('payments.paymentdate','DESC')
         ...
         ->get();
                ...
                return view('superadmin.installmentreminder.filterinstallmentlist',compact('namesfinds','folss','userdata','cour','sourcedata','branchdata','ccatall','datesfor','namedatas','mobdatas','coursedatas','cmodes','sources','fsearch','asearch','bransdata','categorydata','cstartdate','cenddate'));
      } 
