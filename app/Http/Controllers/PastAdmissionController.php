...
class PastAdmissionController extends Controller
{
    /**
      ...
      public function getcourseslist(Request $request)
    {
      ...
      public function repayment($id)
     {
        ...
        return view('superadmin.pastadmissions.repayment',compact('paymentdetails','branc','installmentfees','paymentsse'));
     }
      public function restorepayment(Request $request,$id)
    {
       ...
       if($leadupodat)
       {
        ...
        return redirect('/past-paymentreceipt/'.$paymentid)->with('success','Payment Successfully Done!!!');
    }
    public function index()
    {
        ...
        $userALl = User::all();
            // $currentMonth = date('m');
         $studentsdata = PastAdmission::select('past_admissions.*','pastpayments.*','past_admissions.id as aid')->join('pastpayments', 'pastpayments.pinviceid', '=', 'past_admissions.id')->groupBy('pastpayments.pinviceid')->orderBy('pastpayments.id','DESC')->get(); 
         ...
         return view('superadmin.pastadmissions.manage',compact('studentsdata','brnagch','userALl'));
    }
    ...
    public function create()
    {
        ...
        return view('superadmin.pastadmissions.create',compact('alb','cours','leadsdata','studentdetails','branchdetails','course','taxesna','ucats'));   
    }
     ...
     // dd($request->all());
       ...
       //dd($inoviceno);
...

        {
            ...
            return redirect('/view-past-invoices/'.$invoicesid);
  ...
  public function paymentreceiptlist($id)
    {
      ...
      return view('superadmin.pastadmissions.paymentreceiptlist',compact('result','admissionname'));
    ...
    public function show(PastAdmission $pastAdmission)
   {
        ...
        $sumtotal = $invototal;
         ...
         $pamenreceived = 0; 
           ...
           return view('superadmin.pastadmissions.pendingamount',compact('pendamount','brnagch','userALl','sumtotal','totslreceived','remainingamount'));
    ...
    public function edit(PastAdmission $pastAdmission)
    {
       ...
       $sourcedata = Source::get();
        ...
        $invoicesdata = PastAdmission::select('past_admissions.*','pastpayments.*','past_admissions.id as admid')->join('pastpayments','pastpayments.pinviceid','=','past_admissions.id')->whereMonth('pastpayments.ppaymentdate',$currentMonth)->orderBy('pastpayments.id','DESC')->get();
        ...
        $sumtotal = $invototal;
         ...
         $pamenreceived = $invoicesdata->sum('ppaymentreceived');
            ...
            return view('superadmin.pastadmissions.totalfees',compact('invoicesdata','cour','sourcedata','folss','userdata','sumtotal','totslreceived','remainingamount'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
     public function changeadmissions($id)
    {
         $alb = branch::get();
        $cours = course::get();
        $leadsdata = leads::get();
        ...
        return view('superadmin.pastadmissions.edit',compact('alb','cours','leadsdata','branchdetails','course','taxesna','directstudentsdata','ad','adcourses','ademi','ucats'));
    }
       public function updatepastadmissions($id,Request $request, PastAdmission $pastAdmission)
     { 
        ...
        elseif($request->discounttype == "1")
        {
         ...
         if($request->paymentmode == "EMI")
         {
              ...
              if($request->universitiesss == 'BIT')
                              ...
                              return redirect('/past-student')->with('success','Past Admission Updated successfully!');
    ...
    public function update(Request $request, PastAdmission $pastAdmission)
   {
      ...
      //  dd($pendamount);
        return view('superadmin.pastadmissions.pendingfees',compact('pendamount','sumtotal','totslreceived','remainingamount'));
    ...
    public function viewinvoice($id)
    {
        ...
        return view('superadmin.pastadmissions.newinvoice',compact('aprocess','invvcoursed','installmentfees','univCourse'));
    }
    ...
    public function changeemi($id)
    {
                ...
                return view('superadmin.pastadmissions.changeemi',compact('getinstallmentdata','adm','latestpaymentdata'));
    }
    ...
    {                        /* dd($request->all());*/      
            ...
            return redirect('/make-past-re-payment/'.$id)->with('success','EMI Successfully Changed !!');
    ...
    public function payment($id)
    {
        ...
        return view('superadmin.pastadmissions.makepayment',compact('paymentdetails','branc','installmentfees'));
    }
    ...
    public function paymentreceipt($id)
    {
        ...
        $invvcoursed = DB::select('SELECT * FROM  past_admissions a, courses c, pastadmissioncourses k WHERE c.id = k.pcourseid AND a.id = k.pinvid AND a.id = "'.$newId.'" ');
         ...
         $installdata = pastadmissioninstallmentfees::leftjoin('pastpayments', 'pastpayments.pinstallmentid', '=', 'pastadmissioninstallmentfees.id')->where('pastadmissioninstallmentfees.pinvoid',$newId)->orderBy('pastadmissioninstallmentfees.id','DESC')->get();        
         


        return view('superadmin.pastadmissions.pastpaymentreceipt',compact('aprocess','invvcoursed','univCourse','paymentdata','makepayment','installdata','selectID'));
