...
class MarketingQuotationController extends Controller
{
    ...
    {   
        ...
        $quodetails = studentsQuotation::join('students_quotation_courses','students_quotation_courses.stucompyid','=','students_quotations.id')->select('students_quotations.*','students_quotation_courses.*','students_quotations.id as admid')->where('students_quotations.squsersid',$userId)->groupBy('students_quotation_courses.stucompyid')->orderBy('students_quotations.quotationsdates','desc')->get();
        return view('marketing.quotation.manage',compact('quodetails'));
    ...
    public function create(Request $request)
    {
       ...
       // dd($getid);
        ...
        return view('marketing.quotation.create',compact('quotationdetails','cours','value','brnachdata'));
    ...
    public function editquotations($id,Request $request)
    {
        ...
        $brnachdata = Branch::get();
            ...
            return view('marketing.quotation.edit',compact('quotationdetails','cours','brnachdata','sccourses'));
    }
    ...
    public function updateQuotations($id,Request $request)
    {
                        ...
                        $message->to($data["email"], $data["email"])
                           ...
                           ->cc('support@bitbaroda.com','Admission BIT')
                            ...
                            if (Mail::failures()) {
                                        ...
                                        return redirect('/marketing-quotation')->with('success','Quotation Update SuccessFully and Email Sent Successfully!!!');
        ...
        //return redirect('/marketing-quotation')->with('success','Quotations Updated Successfully!!');
    }
    ...
    public function store(Request $request)
   {
                        ...
                        $message->to($data["email"], $data["email"])
                           ...
                           ->cc('support@bitbaroda.com','Admission BIT')
                            ...
                            if (Mail::failures()) {
                                        ...
                                        return redirect('/marketing-quotation')->with('success','Quotation Create SuccessFully and Email Sent Successfully!!!');
       ...
       public function viewquotations($id)
    {
        ...
        return view('marketing.quotation.quoteview',compact('getdetails','coursedetailsv'));
        ...
        else if($branhanch == "MANIPAL") 
        {
         ...
         $invsjqno ="0";
            ...
            'invmanipalnos'=> $invmanipalqno,
             ...
             return redirect('/marketing-show-invoices-details/'.$id)->with('success','Invoices Created SuccessFully!!!');  
     ...
     public function invoiceslist($id)
    {
        ...
        return view('marketing.quotation.invoiceslists',compact('invlists','invoicessname'));
    }
    ...
    public function shwoinvociesdetails($id)
    {
       ...
       // $invocicescoursedetails = QuotationInvoicesCourses::Join('courses','courses.id','=','quotation_invoices_courses.invstudecompcourse')->select('quotation_invoices_courses.*','courses.coursename')->where('quotation_invoices_courses.invstucompyid',$id)->get(); 'subranchse'=> $userBranchs,
        ...
        return view('marketing.quotation.invoicesview',compact('aprocess','invocicescoursedetails','id'));
    ...
    public function convertoadmissionproccess($id)
    {
       ...
       // dd($directstudentsdata);
        ...
        return view('marketing.quotation.convertoadmissionproccess',compact('cours','branchdetails','cours','course','taxesna','ucats','directstudentsdata'));
    }  
    ...
    public function show(Request $request)
    {
        ...
        return view('marketing.quotation.filterquotations',compact('leadsMob'));
    }
        ...
        if($acategory == "Students") 
         {
            ...
            $invoicesid = $admissionprocess->id;
              ...
              return redirect('/marketing-create-company-payment/'.$invoicesid);
  ...
  public function update($id,Request $request, CompanyQuotation $companyQuotation)
    {
        ...
        return view('marketing.quotation.createpayment',compact('paymentdetails','branc','psource'));
    }
    ...
    public function destroy($id,CompanyQuotation $companyQuotation,Request $request)
     {
       ...
       if($leadupodat)
       {
        ...
        return redirect('/marketing-company-paymentreceipt/'.$paymentid)->with('success','Payment Successfully Done!!!');
    }
    ...
    public function companypaymentreceipts($id)
    {
      ...
      //   dd($payments);
        ...
        return view('marketing.quotation.paymentreceipt',compact('aprocess','invvcoursed','univCourse','paymentdata','makepayment','installdata','selectID','compadmissiondetails'));
